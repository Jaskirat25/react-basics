  ...
  return (
    <>
      ...
      <div className="bg-slate-800 h-screen flex flex-col items-center justify-start  ">
        ...
        <div className=" flex flex-col bg-transparent h-screen w-[80%] mt-10 space-y-3">
          {p.length > 0 ? (
            p.map((item) => (
              <div>
                <div className="flex border-2 rounded-lg">
                  ...
                  >
                    ...
                    <p className="break-words mt-2">{item.content}</p>
                  </div>
                  <div className="p-4 flex flex-row">
                    <button
                      onClick={() => handleview(item._id)}
                      className="border text-white  p-1 h-10"
                    >
                      view
                    </button>
                    <button
